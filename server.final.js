...
// Rota raiz - FORÇAR redirecionamento para /login
app.get('/', (req, res) => {
  console.log('🔄 FORÇANDO redirecionamento de / para /login');
  // Usar 302 redirect em vez de 301 para garantir que funcione
...
app.listen(PORT, () => {
  ...
  console.log(`🔄 Redirecionamento FORÇADO: / → /login`);
